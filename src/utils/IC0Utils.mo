...
module {
    ...
    let ic00 = actor "aaaaa-aa" : actor {
        ...
        update_settings : { canister_id : Principal; settings : canister_settings; } -> ();
    };
    ...
    public func update_settings_add_controller(cid : Principal, controller : Principal) : async () {
        ...
        ic00.update_settings({ canister_id = cid; settings = { controllers = List.toArray(controllerList) }; });
    };
    ...
    public func update_settings_remove_controller(cid : Principal, controller : Principal) : async () {
        ...
        ic00.update_settings({ canister_id = cid; settings = { controllers = controllers }; });
    };
    ...
    public func canister_status(cid : Principal) : async { settings : { controllers : [Principal] }; } {
